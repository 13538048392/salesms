...
(function(factory) {
    ...
    (function(H) {
        ...
        var win = H.win,
            ...
            specialKeys = ['z', 'open', 'high', 'q3', 'median', 'q1', 'low', 'close']; // Tell admin about all properties if points have one of these defined
        ...
        H.Chart.prototype.addKeyboardNavEvents = function() {
            ...
            // Init nav module index. We start at the first module, and as the admin navigates through the chart the index will increase to use different handler modules.
        ...
        H.Chart.prototype.addScreenReaderRegion = function(tableId) {
            ...
            if (chart.getCSV) {
                ...
                tableShortcutAnchor.setAttribute('tabindex', '-1'); // Make this unreachable by admin tabbing
