...
["sScrollY","sY"],["bScrollCollapse","bCollapse"]]);D(k.oLanguage,h,"fnInfoCallback");y(k,"aoDrawCallback",h.fnDrawCallback,"admin");y(k,"aoServerParams",h.fnServerParams,"admin");y(k,"aoStateSaveParams",h.fnStateSaveParams,"admin");y(k,"aoStateLoadParams",h.fnStateLoadParams,"admin");y(k,"aoStateLoaded",h.fnStateLoaded,"admin");y(k,"aoRowCallback",h.fnRowCallback,"admin");y(k,"aoRowCreatedCallback",h.fnCreatedRow,"admin");y(k,"aoHeaderCallback",h.fnHeaderCallback,"admin");y(k,"aoFooterCallback",h.fnFooterCallback,
"admin");y(k,"aoInitComplete",h.fnInitComplete,"admin");y(k,"aoPreDrawCallback",h.fnPreDrawCallback,"admin");n=k.oClasses;h.bJQueryUI?(g.extend(n,p.ext.oJUIClasses,h.oClasses),h.sDom===m.sDom&&"lfrtip"===m.sDom&&(k.sDom='<"H"lfr>t<"F"ip>'),k.renderer)?g.isPlainObject(k.renderer)&&!k.renderer.header&&(k.renderer.header="jqueryui"):k.renderer="jqueryui":g.extend(n,p.ext.classes,h.oClasses);g(this).addClass(n.sTable);if(""!==k.oScroll.sX||""!==k.oScroll.sY)k.oScroll.iBarWidth=Db();!0===k.oScroll.sX&&(k.oScroll.sX=
