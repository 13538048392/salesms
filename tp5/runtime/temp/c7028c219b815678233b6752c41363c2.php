<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\www\salesms\tp5\public/../application/admin\view\admin\lst.html";i:1531903706;s:43:"../application/admin/view/public/_meta.html";i:1531895463;s:45:"../application/admin/view/public/_footer.html";i:1531879298;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		...
		<a href="javascript:;" onclick="admin_add('添加管理员','/index.php/admin/admin/add.html','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			<tr class="text-c">
				...
				<td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','/index.php/admin/admin/edit?id=1','1','800','500')" class="ml-5" style="text-decoration:none">
